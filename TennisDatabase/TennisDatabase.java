...
public class TennisDatabase implements TennisDatabaseInterface {
	...
	//Loads Player and Matches from files In case of wrong/incomplete data skips over the line
	@Override
   ...
   public int numMatches(){
	...
	//Deletes a player from TennisPlayerContainer. If player doesn't exists gives error.
	@Override
	...
	//Updates score after a match is added Gets both players in match and updates their win/lose ration as well
